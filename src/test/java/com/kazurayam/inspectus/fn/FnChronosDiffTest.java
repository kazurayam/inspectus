...
import com.kazurayam.inspectus.zest.SampleFixtureInjector;
...
public class FnChronosDiffTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FnChronosDiffTest.class);
    ...
    public void test_createAppleImage() throws IOException, MaterialstoreException {
        ...
        Path images = fixturesDirectory.resolve("images");
        Path apple = images.resolve("apple.png");
        BufferedImage baseImage = ImageIO.read(apple.toFile());
        BufferedImage clockImage = SampleFixtureInjector.createAppleImage(jt);
    ...
    private final BiFunction<Parameters, Intermediates, Intermediates> fn =
        ...
        try {
            BufferedImage appleWithTimestamp = SampleFixtureInjector.createAppleImage(jt);
